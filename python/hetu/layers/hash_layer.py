...
class HashLayer(BaseLayer):
    def __init__(self, gate = None, experts = None, num_tokens = None, embed_dim = None, all2all_size = None, name='HashLayer'):
        self.name = name
        self.gate = gate
    ...
    def __call__(self, x, indice):
        ...
        indices_s, location_s, capacity =self.gate(reshaped_input, indice)
        ...
        expert_output = ht.reverse_layout_transform_no_gate_op(expert_output, indices_s, location_s, capacity, self.num_local_experts * self.all2all_size)   
