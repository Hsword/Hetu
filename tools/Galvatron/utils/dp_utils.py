...
def estimate_bsz_start_8gpus(type,scale,max_bsz_estimator):
    prune_percent = 0.4
    if type == 'full':
        baselines = [[1,1,8,{'fsdp':0}],[1,8,1,{'fsdp':0}],[8,1,1,{}],[1,1,8,{'fsdp':1}]]
    elif type == 'dp+tp':
        baselines = [[1,1,8,{'fsdp':0}],[1,8,1,{'fsdp':0}]]
    elif type == 'dp+pp':
        baselines = [[1,1,8,{'fsdp':0}],[8,1,1,{}]]
        prune_percent = 0
