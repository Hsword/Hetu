...
from galvatron.models.baichuan.BaiChuanModel_hybrid_parallel import get_hybrid_parallel_configs, construct_hybrid_parallel_model
from galvatron.models.baichuan.dataloader import DataLoaderForBaiChuan
...
def train(args):
    ...
    # from galvatron.models.baichuan import baichuan_model_hp
    # model = baichuan_model_hp(config, args)
