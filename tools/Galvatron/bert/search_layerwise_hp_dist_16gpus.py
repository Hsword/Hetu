...
def parallelism_optimization(args):
    ...
    if hidden_size == 1024:
        ...
        tp_activation_per_bsz_dict = {  1:85.00833, 
                                        ...
                                        8:18.54875,
                                        16:13.5587}
        other_memory_pp_off = {'model_states': 640, 'activation': 260}
        other_memory_pp_on = {'first_stage':{'model_states': 500, 'activation': 260}, 'last_stage':{'model_states': 526, 'activation': 257}}
        memcost_model_args = {  'parameter_size': parameter_size,
                                ...
                                'peak_reduction_with_chunks': 120,
        ...
        tp_activation_per_bsz_dict = {  1:94.07, 
                                        ...
                                        8:21.61171875,
                                        16:16.4509375}
        other_memory_pp_off = {'model_states': 800, 'activation': 280}
        other_memory_pp_on = {'first_stage':{'model_states': 620, 'activation': 330}, 'last_stage':{'model_states': 662, 'activation': 260}}
        memcost_model_args = {  'parameter_size': parameter_size,
                                'tp_activation_per_bsz_dict': tp_activation_per_bsz_dict,
                                'other_memory_pp_off': other_memory_pp_off,
                                'other_memory_pp_on': other_memory_pp_on,
