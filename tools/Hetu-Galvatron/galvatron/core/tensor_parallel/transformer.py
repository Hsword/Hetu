...
class ParallelMLP(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method, act_func="gelu", tp_group=None):
...
class CoreAttention(MegatronModule):
    ...
    def print_peak_memory(self,prefix, device, type='allocated'):
        if type == 'allocated':
    ...
    def forward(self, query_layer, key_layer,
        ...
        #     self.print_peak_memory("attention start", 0)
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("after matmul buffer", 0)
        ...
        # # Modified matmul, not using tensor buffer
        # # Raw attention scores. [b * np, sq, sk]
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("matmul", 0)
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("softmax", 0)
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("dropout", 0)
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("context", 0)
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("context permute", 0)
        ...
        # if torch.distributed.get_rank() == 0:
        #     self.print_peak_memory("attention end", 0)
        
        return context_layer


# zsh: Revise to adapt cross attention, correctness not verified
...
class ParallelAttention(MegatronModule):
    ...
    def __init__(self, init_method,
        ...
        if self.use_flash_attn:
            ...
            # zsh: Revise to accept cross attention and non-causal mask
        ...
        if self.use_flash_attn:
            # zsh: Revise to accppet non-causal mask
            self.core_attention_flash = FlashSelfOrCrossAttention(
                causal=attn_mask_type == AttnMaskType.causal, attention_dropout=args.attention_dropout
            )
