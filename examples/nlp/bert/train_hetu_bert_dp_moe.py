    ...
    for ep in range(num_epochs):
        ...
        for train_file in train_files:
            ...
            for i in range(batch_num_per_device):
                ...
                print_rank0('(Iteration %d): MLM_loss = %.3f, NSP_loss = %.6f, Throughput = %.3f samples/s'%(step_num, masked_lm_loss_mean_out, next_sentence_loss_mean_out, args.train_batch_size*nrank/(end_time-start_time)), rank)
                step_num += 1
                global_step_num += 1
