...
def get_tokenizer(model='google/bigbird-roberta-base'):
...
def main():
    ...
    # str
    parser.add_argument("--model", default="google/bigbird-roberta-base", type=str, required=False,
                        help="BigBird pre-trained model selected in the list: google/bigbird-roberta-base, "
                              "google/bigbird-roberta-large, google/bigbird-roberta-large.")
