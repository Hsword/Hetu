    ...
    def __init__(
        ...
        **kwargs
        ...
        if text_config_dict is None:
            text_config_dict = {}
            print("text_config_dict is None. Initializing the CLIPTextConfig with default values.")

        if vision_config_dict is None:
            vision_config_dict = {}
            print("vision_config_dict is None. initializing the CLIPVisionConfig with default values.")
