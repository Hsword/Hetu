...
import logging
import hetu as ht
from hetu_gpt2 import GPT2ForSequenceClassification
...
def finetune(args):
    ...
    if task_name in ['sst-2','cola']:
        new_num_tokens = vocab_size + 3
    else:
        new_num_tokens = vocab_size + 4
        
    config = GPT2Config(vocab_size=new_num_tokens, 
    ...
    if not os.path.exists('pytorch_model.bin'):
        origin = "https://huggingface.co/gpt2/resolve/main/pytorch_model.bin"
