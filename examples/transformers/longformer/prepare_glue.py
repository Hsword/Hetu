...
def get_tokenizer(model='allenai/longformer-base-4096', add_tokens=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_to_mrpc', help='path to directory containing extracted MRPC data, msr_paraphrase_train.txt and msr_paraphrase_text.txt',
                        type=str, default='')
    parser.add_argument('-m', '--max_seq_length', default=512, type=int, help="The maximum total input sequence length after WordPiece ")
