...
if __name__ == "__main__":
    ...
    # pipeline parallel
    with ht.context([ht.cpu(0), ht.gpu(0), ht.gpu(2)]):
        x = ht.dataloader_op([
    ...
    with ht.context([ht.cpu(0), ht.gpu(1), ht.gpu(3)]):
        ...
        executor = ht.Executor({"train" : [loss, train_op], "validate" : [loss]}, seed=0, pipeline="pipedream", bsp = 1)
    ...
    def validate():
        ...
        if executor.rank == 1 or executor.rank == 3:
